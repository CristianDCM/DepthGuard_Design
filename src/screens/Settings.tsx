...
import { getEstadoSistema, isEdgeOnline, isCamaraActiva, logoutAdmin, listarAdmins, invitarAdmin, eliminarAdmin, type EstadoSistema, type AdminUser } from "../lib/supabase";
                  ...
                  <div className="space-y-2">
                    {admins.map((admin) => (
                      ...
                      >
                        ...
                        {/* Botón eliminar (no se puede eliminar a sí mismo) */}
                        {admin.id !== callerId && (
